  ...
  Widget calcbutton(String btntext,Color btncolor,Color txtcolor){
    return Container(
      child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(shape: CircleBorder(),padding: EdgeInsets.all(20),backgroundColor: btncolor,foregroundColor: txtcolor),
            ...
            Row(
              ...
              children: [
                ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(padding: EdgeInsets.fromLTRB(34, 20, 128, 20),backgroundColor: Colors.grey.shade900,shape: StadiumBorder()),
                ),
